...
dataMapDir = '/scratch2/r/rbond/engelen/new7/lensRecon/maps/dataMaps/actpolDeep/'
    ...
    for cmbSet in numpy.arange(0,numCMBsets):
        ...
        for i, patch in enumerate(nsNames):
            ...
            if doLensing:
                ...
                t=time.time()
                T_map_lensed,Q_map_lensed,U_map_lensed= lensingTools.lensMaps(phi,T_map,Q_map,U_map)
            ...
            T_map_fg = phi.copy()
            T_map_fg.fillWithGaussianRandomField(ls_fg,foregroundPower)

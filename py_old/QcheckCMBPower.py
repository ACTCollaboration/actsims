...
if doAll:
    ...
    power_unl =                statsTools.threedl(nPatches, numCMBsets, iMax - iMin)
    power_lensed =        statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_lensed_beam_cutout = statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_noise =              statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_T_fg_beam =          statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_noise_cutout =       statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_T_fg_beam_cutout =   statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_unl_beam =           statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_beam_cutout =        statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_unl_beam_cutout =    statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    power_unlLenspower_beam_cutout =    statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
    
    power_unlLenspower_beam =                statsTools.fourdl(nPatches, len(nsNamesSubarr[0]), numCMBsets, iMax - iMin)
